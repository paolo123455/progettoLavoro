...
onCellValueChanged( e: CellValueChangedEvent): void {
 console.log(e);
  ...
  select  = ()  => {var query = "select *, descrizione as practice from rilatt.risorse_practice rp "+ 
 ...
 this.insP.select(query).subscribe(response =>{console.log(response) ;this.dati = JSON.parse(JSON.stringify(response)).rows;  this.agGrid.api.setRowData(this.dati)})
  ...
  strucElaboration = () => this.insP.structUndestanding("select * from rilatt.setting_colonne where maschera  = 'risorse_practice'  order by importanza  "
  ).subscribe(response =>{
